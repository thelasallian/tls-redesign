...
import styles from "@/styles/ArticleCards/Style3/SecondaryArticle.module.scss";
...
export default function SecondaryArticle({article}) {
    ...
    return (
        <div className={styles.article__card__wrapper}>
            ...
            <a href="/" className={styles.card__link__wrapper}>
                <div className={styles.card__image__wrapper}>
                    <img className={styles.card__image__img} src={article.jetpack_featured_media_url}/>
                </div>

                <div className={styles.card__information__wrapper}>info</div>
            </a>
        </div>
